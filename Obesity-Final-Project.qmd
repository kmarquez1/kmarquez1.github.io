...
This analysis is meant to provide insight into whether drinking and smoking are just common lifestyle factors or if they actually contribute to higher obesity risk. The findings could be helpful for individuals trying to make healthier choices, as well as for professionals working in health education or policy. By identifying which habits are most strongly associated with obesity, the project hopes to support more informed decisions around personal help and public wellness.
...
| [naniar](https://rpubs.com/jlv7cr/750220)    | to check for missing values                          |
...
| yarstick                                     | to calculate model performance metrics like accuracy |
...
In the future, it would help to have a dataset with more detailed health and lifestyle information, and one that clearly defines the outcome labels. And since this project is about people\'s health, it\'s important to use results like these to support and inform---not to label or judge anyone.
