...
In the future, it would help to have a dataset with more detailed health and lifestyle information, and one that clearly defines the outcome labels especially obesity levels. And since this project is about people\'s health, it\'s important to use results like these to support and inform---not to label or judge anyone.
